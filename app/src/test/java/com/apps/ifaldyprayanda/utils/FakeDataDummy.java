...
//    untuk mendapatkan data dari generateDataTv
    ...
    public static ArrayList<MovieResponse> generateRemoteMovie()
    {
        ArrayList<MovieResponse> movies = new ArrayList<>();

        movies.add(new MovieResponse("m01",
                "Joker",
                "2019-10-04",
                "https://image.tmdb.org/t/p/w185/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m02",
                "Terminator: Dark Fate",
                "2019-10-18",
                "https://image.tmdb.org/t/p/w185/vqzNJRH4YyquRiWxCCOH0aXggHI.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m03",
                "Maleficent: Mistress of Evil",
                "2019-10-18",
                "https://image.tmdb.org/t/p/w185/tBuabjEqxzoUBHfbyNbd8ulgy5j.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m04",
                "The Lion King",
                "2019-07-19",
                "https://image.tmdb.org/t/p/w185/2bXbqYdUdNVa8VIWXVfclP2ICtT.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m05",
                "Fast & Furious Presents: Hobbs & Shaw",
                "2019-08-02",
                "https://image.tmdb.org/t/p/w185/kvpNZAQow5es1tSY6XW2jAZuPPG.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m06",
                "Cars",
                "2006-06-09",
                "https://image.tmdb.org/t/p/w185/jpfkzbIXgKZqCZAkEkFH2VYF63s.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m07",
                "One Piece: Stampede",
                "2019-10-24",
                "https://image.tmdb.org/t/p/w185/4E2lyUGLEr3yH4q6kJxPkQUhX7n.jpg",
                "Japan",
        ...
        movies.add(new MovieResponse("m08",
                "Doctor Sleep",
                "2019-11-08",
                "https://image.tmdb.org/t/p/w185/p69QzIBbN06aTYqRRiCOY1emNBh.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m09",
                "The King",
                "2019-10-11",
                "https://image.tmdb.org/t/p/w185/8u0QBGUbZcBW59VEAdmeFl9g98N.jpg",
                "English",
        ...
        movies.add(new MovieResponse("m10",
                "Dark Phoenix",
                "2019-06-07",
                "https://image.tmdb.org/t/p/w185/cCTJPelKGLhALq3r51A9uMonxKj.jpg",
                "English",
    ...
    public static ArrayList<TvShowResponse> generateRemoteTvShow()
    {
        ArrayList<TvShowResponse> tvShows = new ArrayList<>();

        tvShows.add(new TvShowResponse("t01",
                "Supernatural",
                "2005-09-13",
                "https://image.tmdb.org/t/p/w500/KoYWXbnYuS3b0GyQPkbuexlVK9.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t02",
                "Fear the Walking Dead",
                "2015-08-23",
                "https://image.tmdb.org/t/p/w500/lZMb3R3e5vqukPbeDMeyYGf2ZNG.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t03",
                "His Dark Materials",
                "2019-11-03",
                "https://image.tmdb.org/t/p/w500/xOjRNnQw5hqR1EULJ2iHkGwJVA4.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t04",
                "Arrow",
                "2012-10-10",
                "https://image.tmdb.org/t/p/w500/gKG5QGz5Ngf8fgWpBsWtlg5L2SF.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t05",
                "The Flash",
                "2014-10-07",
                "https://image.tmdb.org/t/p/w500/wHa6KOJAoNTFLFtp7wguUJKSnju.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t06",
                "The Simpsons",
                "1989-12-17",
                "https://image.tmdb.org/t/p/w500/yTZQkSsxUFJZJe67IenRM0AEklc.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t07",
                "See",
                "2019-11-01",
                "https://image.tmdb.org/t/p/w500/g3JsScc7mQCfc3e5e5rXwu7xVVP.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t08",
                "4 Blocks",
                "2017-05-08",
                "https://image.tmdb.org/t/p/w500/jVObyxtNxuPbG5czuKvm7pW56EV.jpg",
                "Deutch",
        ...
        tvShows.add(new TvShowResponse("t09",
                "Riverdale",
                "2017-01-26",
                "https://image.tmdb.org/t/p/w500/4X7o1ssOEvp4BFLim1AZmPNcYbU.jpg",
                "English",
        ...
        tvShows.add(new TvShowResponse("t10",
                "The End of the F***ing World",
                "2017-10-24",
                "https://image.tmdb.org/t/p/w500/xzwwzmXbz6n2Y3fc0GbjqGiFQPm.jpg",
                "English",
